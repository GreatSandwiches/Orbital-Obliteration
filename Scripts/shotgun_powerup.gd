...
func _ready() -> void:
	# Connect signals to the shotgun power-up collection functions for players and AI
...
# Handles the collection of the shotgun power-up by players or AI
...
func _duration_end() -> void:
	...
	show()
	global.shotgun_power_hidden = false
...
func _emit_collect_signal(signal_to_emit: Signal) -> void:
	...
	global.shotgun_power_hidden = true
